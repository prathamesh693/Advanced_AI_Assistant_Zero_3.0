...
class ZeroUI(QWidget):
    ...
    def init_ui(self):
        ...
        self.add_gif_to_label(self.mic_label,
                              r"R:\Projects\3_Advanced_AI_Assistant\ZERO_3.0\USER_INTERFACE\XDZT.gif", size=(720,220), alignment=Qt.AlignCenter) # Initial size and alignment
