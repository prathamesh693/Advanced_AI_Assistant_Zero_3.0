...
# Load the JSON data
with open(r'R:\Projects\3_Advanced_AI_Assistant\ZERO_3.0\DATA\BRAIN_DATA\QNA_DATA\qna.json', encoding='utf-8') as file:
    data = json.load(file)
...
for intent in data.get('intents', []):
    if 'patterns' in intent:
        ...
        print(f"Warning: 'patterns' key is missing from intent: {intent}")
